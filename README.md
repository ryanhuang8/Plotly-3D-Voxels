...
- Note: this code is intended to work for voxels with either 0 or 1s; to customize for other values, edits can be made to `VoxelData.py` (see line #46)
- Another note: make sure to change line #8 to fit your npy array format (e.g. remove the [1][0] part)
